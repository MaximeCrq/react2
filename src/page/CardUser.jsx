    ...
    const USERS=[
      ...
      function App12() {
        ...
        return (
          ...
          {USERS.map(element =><Card  
          
          key={count++} bgColor={bgColors[element.sexe] }sexe={element.sexe} pseudo={element.pseudo} email={element.email} image={element.image} description={element.description}
          />)}
          </>
        )
      }
